...
export default class Sensor extends Component {
 ...
 componentDidMount() {
  ...
  _slow = () => {
    Exponent.Accelerometer.setUpdateInterval(1000);
    Exponent.Gyroscope.setUpdateInterval(1000);
  }

  _fast = () => {
    Exponent.Accelerometer.setUpdateInterval(16);
    Exponent.Gyroscope.setUpdateInterval(16);
  }

  _subscribe = () => {
    this._subscription = Exponent.Accelerometer.addListener((result) => {
  ...
  _subscribe1 = () => {
    this._subscription1 = Exponent.Gyroscope.addListener((result) => {
